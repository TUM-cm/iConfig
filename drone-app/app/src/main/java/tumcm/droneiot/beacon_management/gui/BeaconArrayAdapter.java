...
public class BeaconArrayAdapter extends ArrayAdapter<BeaconUnregistered> {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    TextView macAddressField = convertView.findViewById(R.id.macAddress);
    macAddressField.setText(beaconUnregistered.getMac());
    TextView sBeaconIdField = convertView.findViewById(R.id.sBeaconId);
    sBeaconIdField.setText(beaconUnregistered.getSBeaconId());
    TextView rssiField = convertView.findViewById(R.id.rssi);
